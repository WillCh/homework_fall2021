...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        permutations = np.random.permutation(batch_size)

        return (
            self.obs[permutations],
            self.acs[permutations],
            self.rews[permutations],
            self.next_obs[permutations],
            self.terminals[permutations],
        )
